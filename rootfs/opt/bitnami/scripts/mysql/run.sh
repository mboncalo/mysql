...
flags=("--defaults-file=${DB_CONF_DIR}/my.cnf" "--basedir=${DB_BASE_DIR}" "--datadir=${DB_DATA_DIR}" "--socket=${DB_SOCKET_FILE}" "--server-id=${DEFAULT_SERVER_ID}" "--log-bin=${EXLOGBIN}" "--binlog-format=${BINLOG}")
